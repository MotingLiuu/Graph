...
class KGEModel(torch.nn.Module):
    ...
    def test(self,
        ...
        '''Evaluates the model qulity by computing Mean Rank, MRR and Hits@ :math: 'k' across all possible tail entitites
        ...
        Args:
            ...
            k (int, optional): The :math: 'k' in Hits @ :math: 'k'
                (default: :obj: '10')
            log (bool, optional): if set to :obj:'False', will not print a progress bar to the console. (default: :obj:'True')
        '''
